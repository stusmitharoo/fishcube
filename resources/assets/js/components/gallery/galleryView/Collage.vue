<template>
	<div>
		<div class="base-menu col-xs-12 row">
		    ...
		    <div class="col-xs-2"> 
		        <a v-if="auth" class="words" id="show-modal"> 
		        ...
		        <a v-else="" class="words" id="show-modal"> 
			...
			<div class="col-xs-2"> 
		        ...
		        <a v-else="" class="words"> 
		            <a class="words btn btn-sm" :href="'/gallery/collage/show/' + galleryHeader.id"> 
		                <span class="glyphicon glyphicon-th"></span><h6 class="links-zero">collage</h6> 
		            </a> 
		        </a> 
		    </div> 
        ...
        <collagepic v-for="galleryPicture in galleryPictures" :galleryPicture="galleryPicture">
...
<script>
import CollagePic from './CollagePic.vue'
