...
@section('content')
    <h4 class="words">List your'e galleries</h4>
	<div class="row padding-s">
        <div class="col-xs-4 background "> 
            <a href="{{ route('gallery.list.index',['1'])}}">  
	        <div class="box">       
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('gallery.list.index',['3'])}}">
	        <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('gallery.list.index',['4'])}}">
	        <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.list.index',['2'])}}">
	        <div class="box">
        ...
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.list.index',['5'])}}">
	        <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.list.index',['8'])}}">
	        <div class="box">
        ...
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.list.index',['7'])}}">
			<div class="box">
        ...
        <div class="col-xs-4 background">
        	<a href="{{ route('gallery.list.index',['6'])}}">
	        <div class="box">
