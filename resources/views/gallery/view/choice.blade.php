...
@section('content')
    <h4 class="words">Search all galleries</h4>
	<div class="row padding-s">
        <div class="col-xs-4 background "> 
            <a href="{{ route('gallery.view.index',['1'])}}">  
	        <div class="box">       
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('gallery.view.index',['3'])}}">
	        <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('gallery.view.index',['4'])}}">
	        <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.view.index',['2'])}}">
	        <div class="box">
        ...
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.view.index',['5'])}}">
	        <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.view.index',['8'])}}">
	        <div class="box">
        ...
        <div class="col-xs-4 background">
         	<a href="{{ route('gallery.view.index',['7'])}}">
			<div class="box">
        ...
        <div class="col-xs-4 background">
        	<a href="{{ route('gallery.view.index',['6'])}}">
	        <div class="box">
