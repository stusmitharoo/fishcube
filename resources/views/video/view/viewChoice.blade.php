...
@section('content')
    <h4 class="words">Search all videos</h4>
    <div class="row padding-s">
        <div class="col-xs-4 background "> 
            <a href="{{ route('video.views.index',['1'])}}">  
            <div class="box">       
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('video.views.index',['3'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('video.views.index',['4'])}}">
            <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
            <a href="{{ route('video.views.index',['2'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('video.views.index',['5'])}}">
            <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
            <a href="{{ route('video.views.index',['8'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('video.views.index',['7'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('video.views.index',['6'])}}">
            <div class="box">
