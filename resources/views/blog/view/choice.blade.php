...
@section('content')
    <h4 class="words">Search all blogs</h4>
    <div class="row padding-s">
        <div class="col-xs-4 background "> 
            <a href="{{ route('blog.view.index',['1'])}}">  
            <div class="box">       
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('blog.view.index',['3'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('blog.view.index',['4'])}}">
            <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
            <a href="{{ route('blog.view.index',['2'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('blog.view.index',['5'])}}">
            <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
            <a href="{{ route('blog.view.index',['8'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('blog.view.index',['7'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('blog.view.index',['6'])}}">
            <div class="box">
