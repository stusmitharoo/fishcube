...
@section('title')
	FishCube Card Choice 
@endsection

@section('content')
    <div class="row padding-s">
        <div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 background "> 
            <a href="{{ route('selector.index',['1'])}}">  
            <div class="box">       
