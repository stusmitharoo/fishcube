...
@section('content')
    <h4 class="words">Create a card</h4>
    <div class="row padding-s">
        <div class="col-xs-4 background "> 
            <a href="{{ route('create.card.index',['1'])}}">  
            <div class="box">       
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('create.card.index',['3'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('create.card.index',['4'])}}">
            <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
            <a href="{{ route('create.card.index',['2'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('create.card.index',['5'])}}">
            <div class="box">
    ...
    <div class="row padding-s">
        <div class="col-xs-4 background">
            <a href="{{ route('create.card.index',['8'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('create.card.index',['7'])}}">
            <div class="box">
        ...
        <div class="col-xs-4 background">
            <a href="{{ route('create.card.index',['6'])}}">
            <div class="box">
